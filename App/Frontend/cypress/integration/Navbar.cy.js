...
describe('Navbar Page', () => {
    describe('Navbar links', () => {
        ...
        it('Sign In', () => {
            //checks that the navbar link to 'find healers' exists
            cy.get('#root > nav > div.sign-up-buttons > a.sign-in-button > button')
                .should('be.visible')
                .click();
            //check correct routing:
            cy.url()
        ...
        it('Sign Up', () => {
            //checks that the navbar link to 'find healers' exists
            cy.get('#root > nav > div.sign-up-buttons > a.sign-up-button > button')
                .should('be.visible')
                .click();
            //check correct routing:
            cy.url()
    ...
    describe('Navbar Updates on Sign In', () => {
        it('Sign In as Test User', () => {
            //STUBBED
            //To-Do: sign in as a test user. The Sign In and Sign Up buttons should be replaced 
            //by Account and Sign Out buttons. 
